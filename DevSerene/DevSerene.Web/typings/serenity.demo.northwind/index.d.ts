...
declare namespace Serenity.Demo.Northwind {
    namespace CustomerService {
        ...
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function GetNextNumber(request: Extensions.GetNextNumberRequest, onSuccess?: (response: Extensions.GetNextNumberResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
...
declare namespace Serenity.Demo.Northwind {
    class OrderDetailDialog extends Serenity.Extensions.GridEditorDialog<OrderDetailRow> {
        protected getFormKey(): string;
        protected getLocalTextPrefix(): string;
...
declare namespace Serenity.Demo.Northwind {
    class OrderDetailsEditor extends Extensions.GridEditorBase<OrderDetailRow> {
        protected getColumnsKey(): string;
...
declare namespace Serenity.Demo.Northwind {
    class ProductGrid extends Serenity.EntityGrid<ProductRow, any> {
        ...
        constructor(container: JQuery);
        protected getButtons(): ToolButton[];
        protected onViewProcessData(response: any): ListResponse<ProductRow>;
        /**
